                ...
                <div className="content">
                    ...
                    <Form onSubmit={handleSubmit}>
                        <InputField
                            ...
                            onChange={(e) => dispatch(updateSignUpUsername({ username: e.target.value }))}
                        />
                        <InputField
                            className="input"
                            type="password"
                            ...
                            onChange={(e) => dispatch(updateSignUpPassword({ password: e.target.value }))}
                        />
                        <InputField
                            className="input"
                            type="password"
                            ...
                            onChange={(e) => dispatch(updateSignUpConfirmPassword({ confirmPassword: e.target.value }))}
                        />
                        <Button
